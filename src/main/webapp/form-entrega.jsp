...
<form method="post" action="entrega-servlet">
    ...
    <!-- SELECT de CLIENTE -->
        ...
        <select id="id_cliente" name="id_cliente" required /><br>
        ...
        <!-- SELECT de PRODUTO -->
            ...
            <select id="id_produto" name="id_produto" required /><br>
                <option value="">-- Selecione --</option>
    ...
    <label for="codigo_pedido">Codigo do pedido:</label>
     ...
     <br><br>
      ...
      <label for="valor_frete">Valor do Frete:</label>
               <input type="number" id="valor_frete" name="valor_frete" min= "0.01" step="0.01" placeholder="R$ 0,00" required />
      <br><br>
        <br><br>
